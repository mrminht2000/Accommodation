	...
	<div class="row">
		<div class="col-md-8">
          ...
          @if(session('success'))
					...
					<form action="{{ route ('edithouse', $house->id) }}" method="POST" enctype="multipart/form-data" >
                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<div class="form-group">
							<label for="usr">Tiêu đề bài đăng:</label>
                            <div class="input-group">
                             <input type="text" value="{{$house->title}}" name="title" class="form-control" placeholder="Nhập tiêu đề">
                            </div>
						</div>
						<div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$house->price}}" name="price" class="form-control" placeholder="750000" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="usr">Diện tích(m2):</label>
                                <input type="number" name="size" value="{{$house->size}}" class="form-control" placeholder="16">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-cotrol " data-live-search="true" data-type="provinces" id="province" name="province_id">
                                        <option>{{$house->provinces->name}}</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-cotrol " data-live-search="true" data-type="districts" id="districts" name="id_districts">
                                                        <option>{{ $house->districts->name }}</option>
                                                    </select>
                                </div>
                            </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-cotrol" data-live-search="true" class="form-control" name="id_type"> 
                                        <option data-tokens="#">{{ $house->housetype->name }}</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phoneNumber" value="{{$house->phoneNumber}}" class="form-control" placeholder="0123456789">
                                </div>
                            </div>
                            </div> 
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <br/>
                  <input type="number" value="{{ $house->electricPrice}}" name="electricPrice" id="electricPrice">
                  <br/>
                  <label>Nước(giá thuê 1 m3 nước) :</label>
                  <br/>
                  <input type="number" value="{{ $house->waterPrice}}" id="waterPrice" name="waterPrice">
                </div>
              </div>
            </div>
            <div class="form-group">
              <label for="comment">Mô tả ngắn:</label>
              <textarea class="form-control" rows="5" id="description" name="description" style=" resize: none;">{{ $house->description }}</textarea>
            </div>
            <div class="form-group">

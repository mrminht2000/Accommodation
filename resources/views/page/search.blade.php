				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							@foreach($house as $ho)
							<?php 
								$img_thumb = json_decode($ho->Image,true);
							...
							<div class="col-md-4 col-sm-6">
								<div class="room-item">
									<div class="wrap-img" style="background: url(uploads/images/<?php echo $img_thumb[0]; ?>) center;     background-size: cover;">
										...
										<div class="category">
											<a href="{{route('chitietphong', $ho->id)}}">{{ $ho->housetype->name }}</a>
										</div>
									</div>
									<div class="room-detail">
										...
										<div class="room-info">
											...
											<br/>
											<span>
												<a class="single-item add-to-cart pull-right" href="{{route('follow', $ho->id)}}"><i class="fa fa-shopping-cart"></i></a>
											</span>
											<div><i class="fas fa-map-marker"></i> Địa chỉ: {{ $ho->districts->name }} - {{ $ho->provinces->name }}</div>
